...
const updateRGBColor = () => {
  console.log(`rgb(${inputRed.value}, ${inputGreen.value}, ${inputBlue.value});`);
...
window.onload = () => {
  ...
  rangeRed.addEventListener('change', updateRedValue)
  rangeGreen.addEventListener('change', updateGreenValue)
  rangeBlue.addEventListener('change', updateBlueValue)
}